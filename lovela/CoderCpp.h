...
template <class NodeRangeT = std::vector<Node>&, class CoderT = CoderCpp>
...
inline CodeGeneratorTraverser<> operator>>(std::vector<Node>& nodes, CoderCpp& coder)
{
	return {
		nodes,
		coder,
		[](std::vector<Node>& nodes, CoderCpp& coder)
		{
